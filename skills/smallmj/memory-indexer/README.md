...
**版本**: v1.0.9 | [English](./README_EN.md) | 中文
...
10. **Memory 文件精简**：备份 memory/*.md 到索引，精简大文件到 ~10KB
11. **新对话自动搜索**：Hook 机制，新会话开始时自动检索相关记忆
12. **压缩风险检测**：检测 memory 目录大小，评估压缩风险
13. **使用统计**：查看 memory 文件数量、大小、关键词统计
14. **快照备份**：压缩前自动/手动创建快照，支持恢复
